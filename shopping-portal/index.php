...
<body>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.php"><img style="" src="img/Orgamidecal-hop.png" alt="logo"></a>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <?php
            $c=0;
            $array1 = array("oranges fresh-meat", "vegetables fastfood", "vegetables fresh-meat", "fastfood oranges","fresh-meat vegetables","oranges fastfood","fresh-meat vegetables","fastfood vegetables");
            ...
            ?>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix <?php echo $x ?>">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo $loc.$row["image_file_name"]; ?>">
